...
export default function LoginPage() {
    ...
    return (
        <div className="md-container flex flex-col items-center justify-center min-h-screen bg-[var(--color-primary)]">
            <form onSubmit={handleLogin} className="bg-[var(--color-secondary)] p-8 rounded-lg shadow-lg w-full max-w-md">
                <h1 className="text-3xl mb-6 text-center text-[var(--color-text)]">Login</h1>
